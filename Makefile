...
xml.o: xml.cpp $(HEADERS)
patcher: fantom.o patcher.o screen.o midi.o dump.o trackdef.o monofilter.o transposer.o timestamp.o activity.o controller.o toggler.o networkif.o sequencer.o alarm.o xml.o
	$(CXX) $(LDFLAGS) -o $@ $^
distclean:
	-rm -rf *.o defs.h defs.cpp patcher fantom_cache.bin tags tracks_out.xml
clean: distclean
	-rm -rf now.h
